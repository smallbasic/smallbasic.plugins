...
static int cmd_guicolorpanel(int argc, slib_par_t *params, var_t *retval) {
  auto bounds = get_param_rect(argc, params, 0);
  auto color = get_param_color(argc, params, 1);
...
FUNC_SIG lib_func[] = {
  {1, 1, "CHANGEDIRECTORY", cmd_changedirectory, {-1}},
  {2, 2, "CHECKCOLLISIONBOXES", cmd_checkcollisionboxes, {-1}},
  {3, 3, "CHECKCOLLISIONBOXSPHERE", cmd_checkcollisionboxsphere, {-1}},
  {3, 3, "CHECKCOLLISIONCIRCLEREC", cmd_checkcollisioncirclerec, {-1}},
  {4, 4, "CHECKCOLLISIONCIRCLES", cmd_checkcollisioncircles, {-1}},
  {3, 3, "CHECKCOLLISIONPOINTCIRCLE", cmd_checkcollisionpointcircle, {-1}},
  {2, 2, "CHECKCOLLISIONPOINTREC", cmd_checkcollisionpointrec, {-1}},
  {4, 4, "CHECKCOLLISIONPOINTTRIANGLE", cmd_checkcollisionpointtriangle, {-1}},
  //{2, 2, "CHECKCOLLISIONRAYBOX", cmd_checkcollisionraybox, {-1}},
  //{3, 3, "CHECKCOLLISIONRAYSPHERE", cmd_checkcollisionraysphere, {-1}},
  //{4, 4, "CHECKCOLLISIONRAYSPHEREEX", cmd_checkcollisionraysphereex, {-1}},
  {2, 2, "CHECKCOLLISIONRECS", cmd_checkcollisionrecs, {-1}},
  {4, 4, "CHECKCOLLISIONSPHERES", cmd_checkcollisionspheres, {-1}},
  //{2, 2, "CODEPOINTTOUTF8", cmd_codepointtoutf8, {-1}},
  //{2, 2, "COLORALPHA", cmd_coloralpha, {-1}},
  //{3, 3, "COLORALPHABLEND", cmd_coloralphablend, {-1}},
  //{3, 3, "COLORFROMHSV", cmd_colorfromhsv, {-1}},
  //{1, 1, "COLORFROMNORMALIZED", cmd_colorfromnormalized, {-1}},
  //{1, 1, "COLORNORMALIZE", cmd_colornormalize, {-1}},
  //{1, 1, "COLORTOHSV", cmd_colortohsv, {-1}},
  //{1, 1, "COLORTOINT", cmd_colortoint, {-1}},
  //{3, 3, "COMPRESSDATA", cmd_compressdata, {-1}},
  //{3, 3, "DECOMPRESSDATA", cmd_decompressdata, {-1}},
  {1, 1, "DIRECTORYEXISTS", cmd_directoryexists, {-1}},
  {2, 2, "FADE", cmd_fade, {-1}},
  {1, 1, "FILEEXISTS", cmd_fileexists, {-1}},
  {3, 3, "GENIMAGECELLULAR", cmd_genimagecellular, {-1}},
  {6, 6, "GENIMAGECHECKED", cmd_genimagechecked, {-1}},
  {3, 3, "GENIMAGECOLOR", cmd_genimagecolor, {-1}},
  //{6, 6, "GENIMAGEFONTATLAS", cmd_genimagefontatlas, {-1}},
  {4, 4, "GENIMAGEGRADIENTH", cmd_genimagegradienth, {-1}},
  {5, 5, "GENIMAGEGRADIENTRADIAL", cmd_genimagegradientradial, {-1}},
  {4, 4, "GENIMAGEGRADIENTV", cmd_genimagegradientv, {-1}},
  {5, 5, "GENIMAGEPERLINNOISE", cmd_genimageperlinnoise, {-1}},
  {3, 3, "GENIMAGEWHITENOISE", cmd_genimagewhitenoise, {-1}},
  //{3, 3, "GENMESHCUBE", cmd_genmeshcube, {-1}},
  //{2, 2, "GENMESHCUBICMAP", cmd_genmeshcubicmap, {-1}},
  //{3, 3, "GENMESHCYLINDER", cmd_genmeshcylinder, {-1}},
  //{2, 2, "GENMESHHEIGHTMAP", cmd_genmeshheightmap, {-1}},
  //{3, 3, "GENMESHHEMISPHERE", cmd_genmeshhemisphere, {-1}},
  //{4, 4, "GENMESHKNOT", cmd_genmeshknot, {-1}},
  //{4, 4, "GENMESHPLANE", cmd_genmeshplane, {-1}},
  //{2, 2, "GENMESHPOLY", cmd_genmeshpoly, {-1}},
  //{3, 3, "GENMESHSPHERE", cmd_genmeshsphere, {-1}},
  //{4, 4, "GENMESHTORUS", cmd_genmeshtorus, {-1}},
  //{2, 2, "GENTEXTUREBRDF", cmd_gentexturebrdf, {-1}},
  //{4, 4, "GENTEXTURECUBEMAP", cmd_gentexturecubemap, {-1}},
  //{3, 3, "GENTEXTUREIRRADIANCE", cmd_gentextureirradiance, {-1}},
  //{3, 3, "GENTEXTUREPREFILTER", cmd_gentextureprefilter, {-1}},
  //{1, 1, "GETCAMERAMATRIX", cmd_getcameramatrix, {-1}},
  //{1, 1, "GETCAMERAMATRIX2D", cmd_getcameramatrix2d, {-1}},
  {0, 0, "GETCLIPBOARDTEXT", cmd_getclipboardtext, {-1}},
  //{2, 2, "GETCODEPOINTS", cmd_getcodepoints, {-1}},
  //{1, 1, "GETCODEPOINTSCOUNT", cmd_getcodepointscount, {-1}},
  //{2, 2, "GETCOLLISIONRAYGROUND", cmd_getcollisionrayground, {-1}},
  //{2, 2, "GETCOLLISIONRAYMODEL", cmd_getcollisionraymodel, {-1}},
  //{4, 4, "GETCOLLISIONRAYTRIANGLE", cmd_getcollisionraytriangle, {-1}},
  {2, 2, "GETCOLLISIONREC", cmd_getcollisionrec, {-1}},
  {1, 1, "GETCOLOR", cmd_getcolor, {-1}},
  //{2, 2, "GETDIRECTORYFILES", cmd_getdirectoryfiles, {-1}},
  {1, 1, "GETDIRECTORYPATH", cmd_getdirectorypath, {-1}},
  //{1, 1, "GETDROPPEDFILES", cmd_getdroppedfiles, {-1}},
  //{1, 1, "GETFILEEXTENSION", cmd_getfileextension, {-1}},
  //{1, 1, "GETFILEMODTIME", cmd_getfilemodtime, {-1}},
  //{1, 1, "GETFILENAME", cmd_getfilename, {-1}},
  //{1, 1, "GETFILENAMEWITHOUTEXT", cmd_getfilenamewithoutext, {-1}},
  //{0, 0, "GETFONTDEFAULT", cmd_getfontdefault, {-1}},
  {0, 0, "GETFPS", cmd_getfps, {-1}},
  {0, 0, "GETFRAMETIME", cmd_getframetime, {-1}},
  //{1, 1, "GETGAMEPADAXISCOUNT", cmd_getgamepadaxiscount, {-1}},
  //{2, 2, "GETGAMEPADAXISMOVEMENT", cmd_getgamepadaxismovement, {-1}},
  {0, 0, "GETGAMEPADBUTTONPRESSED", cmd_getgamepadbuttonpressed, {-1}},
  //{1, 1, "GETGAMEPADNAME", cmd_getgamepadname, {-1}},
  {0, 0, "GETGESTUREDETECTED", cmd_getgesturedetected, {-1}},
  {0, 0, "GETGESTUREDRAGANGLE", cmd_getgesturedragangle, {-1}},
  //{0, 0, "GETGESTUREDRAGVECTOR", cmd_getgesturedragvector, {-1}},
  {0, 0, "GETGESTUREHOLDDURATION", cmd_getgestureholdduration, {-1}},
  {0, 0, "GETGESTUREPINCHANGLE", cmd_getgesturepinchangle, {-1}},
  //{0, 0, "GETGESTUREPINCHVECTOR", cmd_getgesturepinchvector, {-1}},
  //{2, 2, "GETGLYPHINDEX", cmd_getglyphindex, {-1}},
  //{2, 2, "GETIMAGEALPHABORDER", cmd_getimagealphaborder, {-1}},
  {1, 1, "GETIMAGEDATA", cmd_getimagedata, {-1}},
  //{1, 1, "GETIMAGEDATANORMALIZED", cmd_getimagedatanormalized, {-1}},
  //{3, 3, "GETIMAGEPALETTE", cmd_getimagepalette, {-1}},
  {0, 0, "GETKEYPRESSED", cmd_getkeypressed, {-1}},
  //{0, 0, "GETMATRIXMODELVIEW", cmd_getmatrixmodelview, {-1}},
  //{0, 0, "GETMATRIXPROJECTION", cmd_getmatrixprojection, {-1}},
  {0, 0, "GETMONITORCOUNT", cmd_getmonitorcount, {-1}},
  {1, 1, "GETMONITORHEIGHT", cmd_getmonitorheight, {-1}},
  {1, 1, "GETMONITORNAME", cmd_getmonitorname, {-1}},
  {1, 1, "GETMONITORPHYSICALHEIGHT", cmd_getmonitorphysicalheight, {-1}},
  {1, 1, "GETMONITORPHYSICALWIDTH", cmd_getmonitorphysicalwidth, {-1}},
  {1, 1, "GETMONITORREFRESHRATE", cmd_getmonitorrefreshrate, {-1}},
  {1, 1, "GETMONITORWIDTH", cmd_getmonitorwidth, {-1}},
  {0, 0, "GETMOUSECURSOR", cmd_getmousecursor, {-1}},
  {0, 0, "GETMOUSEPOSITION", cmd_getmouseposition, {-1}},
  //{2, 2, "GETMOUSERAY", cmd_getmouseray, {-1}},
  {0, 0, "GETMOUSEWHEELMOVE", cmd_getmousewheelmove, {-1}},
  {0, 0, "GETMOUSEX", cmd_getmousex, {-1}},
  {0, 0, "GETMOUSEY", cmd_getmousey, {-1}},
  {1, 1, "GETMUSICTIMELENGTH", cmd_getmusictimelength, {-1}},
  {1, 1, "GETMUSICTIMEPLAYED", cmd_getmusictimeplayed, {-1}},
  ...
  //{2, 2, "GETSCREENTOWORLD2D", cmd_getscreentoworld2d, {-1}},
  {0, 0, "GETSCREENWIDTH", cmd_getscreenwidth, {-1}},
  //{0, 0, "GETSHADERDEFAULT", cmd_getshaderdefault, {-1}},
  {2, 2, "GETSHADERLOCATION", cmd_getshaderlocation, {-1}},
  {2, 2, "GETSHADERLOCATIONATTRIB", cmd_getshaderlocationattrib, {-1}},
  //{0, 0, "GETSHAPESTEXTURE", cmd_getshapestexture, {-1}},
  //{0, 0, "GETSHAPESTEXTUREREC", cmd_getshapestexturerec, {-1}},
  {0, 0, "GETSOUNDSPLAYING", cmd_getsoundsplaying, {-1}},
  {1, 1, "GETTEXTUREDATA", cmd_gettexturedata, {-1}},
  //{0, 0, "GETTEXTUREDEFAULT", cmd_gettexturedefault, {-1}},
  {0, 0, "GETTIME", cmd_gettime, {-1}},
  {0, 0, "GETTOUCHPOINTSCOUNT", cmd_gettouchpointscount, {-1}},
  //{1, 1, "GETTOUCHPOSITION", cmd_gettouchposition, {-1}},
  {0, 0, "GETTOUCHX", cmd_gettouchx, {-1}},
  {0, 0, "GETTOUCHY", cmd_gettouchy, {-1}},
  //{1, 1, "GETWAVEDATA", cmd_getwavedata, {-1}},
  //{0, 0, "GETWINDOWPOSITION", cmd_getwindowposition, {-1}},
  //{0, 0, "GETWINDOWSCALEDPI", cmd_getwindowscaledpi, {-1}},
  {0, 0, "GETWORKINGDIRECTORY", cmd_getworkingdirectory, {-1}},
  //{2, 2, "GETWORLDTOSCREEN", cmd_getworldtoscreen, {-1}},
  //{2, 2, "GETWORLDTOSCREEN2D", cmd_getworldtoscreen2d, {-1}},
  //{4, 4, "GETWORLDTOSCREENEX", cmd_getworldtoscreenex, {-1}},
  //{1, 1, "IMAGECOPY", cmd_imagecopy, {-1}},
  //{2, 2, "IMAGEFROMIMAGE", cmd_imagefromimage, {-1}},
  //{3, 3, "IMAGETEXT", cmd_imagetext, {-1}},
  //{5, 5, "IMAGETEXTEX", cmd_imagetextex, {-1}},
  //{3, 3, "INITAUDIOSTREAM", cmd_initaudiostream, {-1}},
  {0, 0, "ISAUDIODEVICEREADY", cmd_isaudiodeviceready, {-1}},
  //{1, 1, "ISAUDIOSTREAMPLAYING", cmd_isaudiostreamplaying, {-1}},
  //{1, 1, "ISAUDIOSTREAMPROCESSED", cmd_isaudiostreamprocessed, {-1}},
  {0, 0, "ISCURSORHIDDEN", cmd_iscursorhidden, {-1}},
  {0, 0, "ISCURSORONSCREEN", cmd_iscursoronscreen, {-1}},
  {0, 0, "ISFILEDROPPED", cmd_isfiledropped, {-1}},
  {2, 2, "ISFILEEXTENSION", cmd_isfileextension, {-1}},
  {1, 1, "ISGAMEPADAVAILABLE", cmd_isgamepadavailable, {-1}},
  {2, 2, "ISGAMEPADBUTTONDOWN", cmd_isgamepadbuttondown, {-1}},
  {2, 2, "ISGAMEPADBUTTONPRESSED", cmd_isgamepadbuttonpressed, {-1}},
  {2, 2, "ISGAMEPADBUTTONRELEASED", cmd_isgamepadbuttonreleased, {-1}},
  {2, 2, "ISGAMEPADBUTTONUP", cmd_isgamepadbuttonup, {-1}},
  {2, 2, "ISGAMEPADNAME", cmd_isgamepadname, {-1}},
  {1, 1, "ISGESTUREDETECTED", cmd_isgesturedetected, {-1}},
  {1, 1, "ISKEYDOWN", cmd_iskeydown, {-1}},
  {1, 1, "ISKEYPRESSED", cmd_iskeypressed, {-1}},
  {1, 1, "ISKEYRELEASED", cmd_iskeyreleased, {-1}},
  {1, 1, "ISKEYUP", cmd_iskeyup, {-1}},
  //{2, 2, "ISMODELANIMATIONVALID", cmd_ismodelanimationvalid, {-1}},
  {1, 1, "ISMOUSEBUTTONDOWN", cmd_ismousebuttondown, {-1}},
  {1, 1, "ISMOUSEBUTTONPRESSED", cmd_ismousebuttonpressed, {-1}},
  {1, 1, "ISMOUSEBUTTONRELEASED", cmd_ismousebuttonreleased, {-1}},
  {1, 1, "ISMOUSEBUTTONUP", cmd_ismousebuttonup, {-1}},
  {1, 1, "ISMUSICPLAYING", cmd_ismusicplaying, {-1}},
  {1, 1, "ISSOUNDPLAYING", cmd_issoundplaying, {-1}},
  {0, 0, "ISVRSIMULATORREADY", cmd_isvrsimulatorready, {-1}},
  {0, 0, "ISWINDOWFOCUSED", cmd_iswindowfocused, {-1}},
  {0, 0, "ISWINDOWFULLSCREEN", cmd_iswindowfullscreen, {-1}},
  {0, 0, "ISWINDOWHIDDEN", cmd_iswindowhidden, {-1}},
  {0, 0, "ISWINDOWMAXIMIZED", cmd_iswindowmaximized, {-1}},
  {0, 0, "ISWINDOWMINIMIZED", cmd_iswindowminimized, {-1}},
  {0, 0, "ISWINDOWREADY", cmd_iswindowready, {-1}},
  ...
  //{2, 2, "LOADIMAGEANIM", cmd_loadimageanim, {-1}},
  //{3, 3, "LOADIMAGEFROMMEMORY", cmd_loadimagefrommemory, {-1}},
  //{5, 5, "LOADIMAGERAW", cmd_loadimageraw, {-1}},
  //{0, 0, "LOADMATERIALDEFAULT", cmd_loadmaterialdefault, {-1}},
  //{2, 2, "LOADMATERIALS", cmd_loadmaterials, {-1}},
  //{2, 2, "LOADMESHES", cmd_loadmeshes, {-1}},
  {1, 1, "LOADMODEL", cmd_loadmodel, {-1}},
  //{2, 2, "LOADMODELANIMATIONS", cmd_loadmodelanimations, {-1}},
  //{1, 1, "LOADMODELFROMMESH", cmd_loadmodelfrommesh, {-1}},
  {1, 1, "LOADMUSICSTREAM", cmd_loadmusicstream, {-1}},
  {2, 2, "LOADRENDERTEXTURE", cmd_loadrendertexture, {-1}},
  {2, 2, "LOADSHADER", cmd_loadshader, {-1}},
  //{2, 2, "LOADSHADERCODE", cmd_loadshadercode, {-1}},
  {1, 1, "LOADSOUND", cmd_loadsound, {-1}},
  {1, 1, "LOADSOUNDFROMWAVE", cmd_loadsoundfromwave, {-1}},
  //{1, 1, "LOADSTORAGEVALUE", cmd_loadstoragevalue, {-1}},
  {1, 1, "LOADTEXTURE", cmd_loadtexture, {-1}},
  //{2, 2, "LOADTEXTURECUBEMAP", cmd_loadtexturecubemap, {-1}},
  {1, 1, "LOADTEXTUREFROMIMAGE", cmd_loadtexturefromimage, {-1}},
  //{1, 1, "LOADWAVE", cmd_loadwave, {-1}},
  //{3, 3, "LOADWAVEFROMMEMORY", cmd_loadwavefrommemory, {-1}},
  {2, 2, "MEASURETEXT", cmd_measuretext, {-1}},
  //{4, 4, "MEASURETEXTEX", cmd_measuretextex, {-1}},
  //{1, 1, "MESHBOUNDINGBOX", cmd_meshboundingbox, {-1}},
  //{2, 2, "TEXTCOPY", cmd_textcopy, {-1}},
  //{2, 2, "TEXTFINDINDEX", cmd_textfindindex, {-1}},
  {1, 1, "TEXTFORMAT", cmd_textformat, {-1}},
  //{3, 3, "TEXTINSERT", cmd_textinsert, {-1}},
  //{2, 2, "TEXTISEQUAL", cmd_textisequal, {-1}},
  //{3, 3, "TEXTJOIN", cmd_textjoin, {-1}},
  //{1, 1, "TEXTLENGTH", cmd_textlength, {-1}},
  //{3, 3, "TEXTREPLACE", cmd_textreplace, {-1}},
  //{3, 3, "TEXTSPLIT", cmd_textsplit, {-1}},
  //{3, 3, "TEXTSUBTEXT", cmd_textsubtext, {-1}},
  //{1, 1, "TEXTTOINTEGER", cmd_texttointeger, {-1}},
  //{1, 1, "TEXTTOLOWER", cmd_texttolower, {-1}},
  //{1, 1, "TEXTTOPASCAL", cmd_texttopascal, {-1}},
  //{1, 1, "TEXTTOUPPER", cmd_texttoupper, {-1}},
  //{2, 2, "TEXTTOUTF8", cmd_texttoutf8, {-1}},
  //{1, 1, "WAVECOPY", cmd_wavecopy, {-1}},
  {0, 0, "WINDOWSHOULDCLOSE", cmd_windowshouldclose, {-1}},
  {2, 2, "GUIBUTTON", cmd_guibutton, {-1}},
  {3, 3, "GUICHECKBOX", cmd_guicheckbox, {-1}},
  {2, 2, "GUICOLORBARALPHA", cmd_guicolorbaralpha, {-1}},
  {2, 2, "GUICOLORBARHUE", cmd_guicolorbarhue, {-1}},
...
FUNC_SIG lib_proc[] = {
  {1, 1, "BEGINBLENDMODE", cmd_beginblendmode, {-1}},
  {0, 0, "BEGINDRAWING", cmd_begindrawing, {-1}},
  //{1, 1, "BEGINMODE2D", cmd_beginmode2d, {-1}},
  {1, 1, "BEGINMODE3D", cmd_beginmode3d, {-1}},
  {4, 4, "BEGINSCISSORMODE", cmd_beginscissormode, {-1}},
  {1, 1, "BEGINSHADERMODE", cmd_beginshadermode, {-1}},
  {1, 1, "BEGINTEXTUREMODE", cmd_begintexturemode, {-1}},
  {0, 0, "BEGINVRDRAWING", cmd_beginvrdrawing, {-1}},
  {1, 1, "CLEARBACKGROUND", cmd_clearbackground, {-1}},
  {0, 0, "CLEARDIRECTORYFILES", cmd_cleardirectoryfiles, {-1}},
  {0, 0, "CLEARDROPPEDFILES", cmd_cleardroppedfiles, {-1}},
  {0, 0, "CLOSEAUDIODEVICE", cmd_closeaudiodevice, {-1}},
  //{1, 1, "CLOSEAUDIOSTREAM", cmd_closeaudiostream, {-1}},
  {0, 0, "CLOSEVRSIMULATOR", cmd_closevrsimulator, {-1}},
  {0, 0, "CLOSEWINDOW", cmd_closewindow, {-1}},
  {0, 0, "DECORATEWINDOW", cmd_decoratewindow, {-1}},
  {0, 0, "DISABLECURSOR", cmd_disablecursor, {-1}},
  //{5, 5, "DRAWBILLBOARD", cmd_drawbillboard, {-1}},
  //{6, 6, "DRAWBILLBOARDREC", cmd_drawbillboardrec, {-1}},
  //{2, 2, "DRAWBOUNDINGBOX", cmd_drawboundingbox, {-1}},
  {4, 4, "DRAWCIRCLE", cmd_drawcircle, {-1}},
  //{5, 5, "DRAWCIRCLE3D", cmd_drawcircle3d, {-1}},
  //{5, 5, "DRAWCIRCLEGRADIENT", cmd_drawcirclegradient, {-1}},
  {4, 4, "DRAWCIRCLELINES", cmd_drawcirclelines, {-1}},
  {6, 6, "DRAWCIRCLESECTOR", cmd_drawcirclesector, {-1}},
  {6, 6, "DRAWCIRCLESECTORLINES", cmd_drawcirclesectorlines, {-1}},
  {3, 3, "DRAWCIRCLEV", cmd_drawcirclev, {-1}},
  {5, 5, "DRAWCUBE", cmd_drawcube, {-1}},
  //{6, 6, "DRAWCUBETEXTURE", cmd_drawcubetexture, {-1}},
  //{3, 3, "DRAWCUBEV", cmd_drawcubev, {-1}},
  //{5, 5, "DRAWCUBEWIRES", cmd_drawcubewires, {-1}},
  //{3, 3, "DRAWCUBEWIRESV", cmd_drawcubewiresv, {-1}},
  //{6, 6, "DRAWCYLINDER", cmd_drawcylinder, {-1}},
  //{6, 6, "DRAWCYLINDERWIRES", cmd_drawcylinderwires, {-1}},
  //{5, 5, "DRAWELLIPSE", cmd_drawellipse, {-1}},
  //{5, 5, "DRAWELLIPSELINES", cmd_drawellipselines, {-1}},
  {2, 2, "DRAWFPS", cmd_drawfps, {-1}},
  {1, 1, "DRAWGIZMO", cmd_drawgizmo, {-1}},
  {2, 2, "DRAWGRID", cmd_drawgrid, {-1}},
  {5, 5, "DRAWLINE", cmd_drawline, {-1}},
  //{3, 3, "DRAWLINE3D", cmd_drawline3d, {-1}},
  //{4, 4, "DRAWLINEBEZIER", cmd_drawlinebezier, {-1}},
  //{4, 4, "DRAWLINEEX", cmd_drawlineex, {-1}},
  //{3, 3, "DRAWLINESTRIP", cmd_drawlinestrip, {-1}},
  //{3, 3, "DRAWLINEV", cmd_drawlinev, {-1}},
  {4, 4, "DRAWMODEL", cmd_drawmodel, {-1}},
  //{6, 6, "DRAWMODELEX", cmd_drawmodelex, {-1}},
  //{4, 4, "DRAWMODELWIRES", cmd_drawmodelwires, {-1}},
  //{6, 6, "DRAWMODELWIRESEX", cmd_drawmodelwiresex, {-1}},
  //{3, 3, "DRAWPIXEL", cmd_drawpixel, {-1}},
  //{2, 2, "DRAWPIXELV", cmd_drawpixelv, {-1}},
  //{3, 3, "DRAWPLANE", cmd_drawplane, {-1}},
  //{2, 2, "DRAWPOINT3D", cmd_drawpoint3d, {-1}},
  //{5, 5, "DRAWPOLY", cmd_drawpoly, {-1}},
  //{5, 5, "DRAWPOLYLINES", cmd_drawpolylines, {-1}},
  //{2, 2, "DRAWRAY", cmd_drawray, {-1}},
  {5, 5, "DRAWRECTANGLE", cmd_drawrectangle, {-1}},
  //{5, 5, "DRAWRECTANGLEGRADIENTEX", cmd_drawrectanglegradientex, {-1}},
  //{6, 6, "DRAWRECTANGLEGRADIENTH", cmd_drawrectanglegradienth, {-1}},
  //{6, 6, "DRAWRECTANGLEGRADIENTV", cmd_drawrectanglegradientv, {-1}},
  {5, 5, "DRAWRECTANGLELINES", cmd_drawrectanglelines, {-1}},
  {3, 3, "DRAWRECTANGLELINESEX", cmd_drawrectanglelinesex, {-1}},
  //{4, 4, "DRAWRECTANGLEPRO", cmd_drawrectanglepro, {-1}},
  {2, 2, "DRAWRECTANGLEREC", cmd_drawrectanglerec, {-1}},
  //{4, 4, "DRAWRECTANGLEROUNDED", cmd_drawrectanglerounded, {-1}},
  //{5, 5, "DRAWRECTANGLEROUNDEDLINES", cmd_drawrectangleroundedlines, {-1}},
  //{3, 3, "DRAWRECTANGLEV", cmd_drawrectanglev, {-1}},
  {7, 7, "DRAWRING", cmd_drawring, {-1}},
  {7, 7, "DRAWRINGLINES", cmd_drawringlines, {-1}},
  {3, 3, "DRAWSPHERE", cmd_drawsphere, {-1}},
  //{5, 5, "DRAWSPHEREEX", cmd_drawsphereex, {-1}},
  ...
  {5, 5, "DRAWTEXTUREEX", cmd_drawtextureex, {-1}},
  //{6, 6, "DRAWTEXTURENPATCH", cmd_drawtexturenpatch, {-1}},
  {6, 6, "DRAWTEXTUREPRO", cmd_drawtexturepro, {-1}},
  //{5, 5, "DRAWTEXTUREQUAD", cmd_drawtexturequad, {-1}},
  {4, 4, "DRAWTEXTUREREC", cmd_drawtexturerec, {-1}},
  //{7, 7, "DRAWTEXTURETILED", cmd_drawtexturetiled, {-1}},
  //{3, 3, "DRAWTEXTUREV", cmd_drawtexturev, {-1}},
  //{4, 4, "DRAWTRIANGLE", cmd_drawtriangle, {-1}},
  //{4, 4, "DRAWTRIANGLE3D", cmd_drawtriangle3d, {-1}},
  //{3, 3, "DRAWTRIANGLEFAN", cmd_drawtrianglefan, {-1}},
  //{4, 4, "DRAWTRIANGLELINES", cmd_drawtrianglelines, {-1}},
  //{3, 3, "DRAWTRIANGLESTRIP", cmd_drawtrianglestrip, {-1}},
  //{3, 3, "DRAWTRIANGLESTRIP3D", cmd_drawtrianglestrip3d, {-1}},
  {0, 0, "ENABLECURSOR", cmd_enablecursor, {-1}},
  {0, 0, "ENDBLENDMODE", cmd_endblendmode, {-1}},
  {0, 0, "ENDDRAWING", cmd_enddrawing, {-1}},
  {0, 0, "ENDMODE2D", cmd_endmode2d, {-1}},
  {0, 0, "ENDMODE3D", cmd_endmode3d, {-1}},
  {0, 0, "ENDSCISSORMODE", cmd_endscissormode, {-1}},
  {0, 0, "ENDSHADERMODE", cmd_endshadermode, {-1}},
  {0, 0, "ENDTEXTUREMODE", cmd_endtexturemode, {-1}},
  {0, 0, "ENDVRDRAWING", cmd_endvrdrawing, {-1}},
  {2, 2, "EXPORTIMAGE", cmd_exportimage, {-1}},
  //{2, 2, "EXPORTIMAGEASCODE", cmd_exportimageascode, {-1}},
  //{2, 2, "EXPORTMESH", cmd_exportmesh, {-1}},
  //{2, 2, "EXPORTWAVE", cmd_exportwave, {-1}},
  //{2, 2, "EXPORTWAVEASCODE", cmd_exportwaveascode, {-1}},
  //{1, 1, "GENTEXTUREMIPMAPS", cmd_gentexturemipmaps, {-1}},
  {0, 0, "GETWINDOWHANDLE", cmd_getwindowhandle, {-1}},
  {0, 0, "HIDECURSOR", cmd_hidecursor, {-1}},
  {0, 0, "HIDEWINDOW", cmd_hidewindow, {-1}},
  //{3, 3, "IMAGEALPHACLEAR", cmd_imagealphaclear, {-1}},
  //{2, 2, "IMAGEALPHACROP", cmd_imagealphacrop, {-1}},
  //{2, 2, "IMAGEALPHAMASK", cmd_imagealphamask, {-1}},
  //{1, 1, "IMAGEALPHAPREMULTIPLY", cmd_imagealphapremultiply, {-1}},
  //{2, 2, "IMAGECLEARBACKGROUND", cmd_imageclearbackground, {-1}},
  {2, 2, "IMAGECOLORBRIGHTNESS", cmd_imagecolorbrightness, {-1}},
  {2, 2, "IMAGECOLORCONTRAST", cmd_imagecolorcontrast, {-1}},
  {1, 1, "IMAGECOLORGRAYSCALE", cmd_imagecolorgrayscale, {-1}},
  {1, 1, "IMAGECOLORINVERT", cmd_imagecolorinvert, {-1}},
  //{3, 3, "IMAGECOLORREPLACE", cmd_imagecolorreplace, {-1}},
  {2, 2, "IMAGECOLORTINT", cmd_imagecolortint, {-1}},
  //{2, 2, "IMAGECROP", cmd_imagecrop, {-1}},
  //{5, 5, "IMAGEDITHER", cmd_imagedither, {-1}},
  //{5, 5, "IMAGEDRAW", cmd_imagedraw, {-1}},
  {5, 5, "IMAGEDRAWCIRCLE", cmd_imagedrawcircle, {-1}},
  //{4, 4, "IMAGEDRAWCIRCLEV", cmd_imagedrawcirclev, {-1}},
  //{6, 6, "IMAGEDRAWLINE", cmd_imagedrawline, {-1}},
  //{4, 4, "IMAGEDRAWLINEV", cmd_imagedrawlinev, {-1}},
  //{4, 4, "IMAGEDRAWPIXEL", cmd_imagedrawpixel, {-1}},
  //{3, 3, "IMAGEDRAWPIXELV", cmd_imagedrawpixelv, {-1}},
  //{6, 6, "IMAGEDRAWRECTANGLE", cmd_imagedrawrectangle, {-1}},
  //{4, 4, "IMAGEDRAWRECTANGLELINES", cmd_imagedrawrectanglelines, {-1}},
  {3, 3, "IMAGEDRAWRECTANGLEREC", cmd_imagedrawrectanglerec, {-1}},
  //{4, 4, "IMAGEDRAWRECTANGLEV", cmd_imagedrawrectanglev, {-1}},
  //{6, 6, "IMAGEDRAWTEXT", cmd_imagedrawtext, {-1}},
  //{7, 7, "IMAGEDRAWTEXTEX", cmd_imagedrawtextex, {-1}},
  {1, 1, "IMAGEFLIPHORIZONTAL", cmd_imagefliphorizontal, {-1}},
  {1, 1, "IMAGEFLIPVERTICAL", cmd_imageflipvertical, {-1}},
  {2, 2, "IMAGEFORMAT", cmd_imageformat, {-1}},
  //{1, 1, "IMAGEMIPMAPS", cmd_imagemipmaps, {-1}},
  //{3, 3, "IMAGERESIZE", cmd_imageresize, {-1}},
  //{6, 6, "IMAGERESIZECANVAS", cmd_imageresizecanvas, {-1}},
  //{3, 3, "IMAGERESIZENN", cmd_imageresizenn, {-1}},
  //{1, 1, "IMAGEROTATECCW", cmd_imagerotateccw, {-1}},
  //{1, 1, "IMAGEROTATECW", cmd_imagerotatecw, {-1}},
  //{2, 2, "IMAGETOPOT", cmd_imagetopot, {-1}},
  {0, 0, "INITAUDIODEVICE", cmd_initaudiodevice, {-1}},
  {0, 0, "INITVRSIMULATOR", cmd_initvrsimulator, {-1}},
  {3, 3, "INITWINDOW", cmd_initwindow, {-1}},
  {0, 0, "MAXIMIZEWINDOW", cmd_maximizewindow, {-1}},
  //{1, 1, "MESHBINORMALS", cmd_meshbinormals, {-1}},
  //{1, 1, "MESHNORMALSSMOOTH", cmd_meshnormalssmooth, {-1}},
  //{1, 1, "MESHTANGENTS", cmd_meshtangents, {-1}},
  {1, 1, "OPENURL", cmd_openurl, {-1}},
  //{1, 1, "PAUSEAUDIOSTREAM", cmd_pauseaudiostream, {-1}},
  {1, 1, "PAUSEMUSICSTREAM", cmd_pausemusicstream, {-1}},
  {1, 1, "PAUSESOUND", cmd_pausesound, {-1}},
  //{1, 1, "PLAYAUDIOSTREAM", cmd_playaudiostream, {-1}},
  {1, 1, "PLAYMUSICSTREAM", cmd_playmusicstream, {-1}},
  {1, 1, "PLAYSOUND", cmd_playsound, {-1}},
  {1, 1, "PLAYSOUNDMULTI", cmd_playsoundmulti, {-1}},
  {0, 0, "RESTOREWINDOW", cmd_restorewindow, {-1}},
  //{1, 1, "RESUMEAUDIOSTREAM", cmd_resumeaudiostream, {-1}},
  {1, 1, "RESUMEMUSICSTREAM", cmd_resumemusicstream, {-1}},
  {1, 1, "RESUMESOUND", cmd_resumesound, {-1}},
  //{3, 3, "SAVEFILEDATA", cmd_savefiledata, {-1}},
  //{2, 2, "SAVEFILETEXT", cmd_savefiletext, {-1}},
  //{2, 2, "SAVESTORAGEVALUE", cmd_savestoragevalue, {-1}},
  //{1, 1, "SETAUDIOSTREAMBUFFERSIZEDEFAULT", cmd_setaudiostreambuffersizedefault, {-1}},
  //{2, 2, "SETAUDIOSTREAMPITCH", cmd_setaudiostreampitch, {-1}},
  //{2, 2, "SETAUDIOSTREAMVOLUME", cmd_setaudiostreamvolume, {-1}},
  //{1, 1, "SETCAMERAALTCONTROL", cmd_setcameraaltcontrol, {-1}},
  {2, 2, "SETCAMERAMODE", cmd_setcameramode, {-1}},
  //{6, 6, "SETCAMERAMOVECONTROLS", cmd_setcameramovecontrols, {-1}},
  //{1, 1, "SETCAMERAPANCONTROL", cmd_setcamerapancontrol, {-1}},
  //{1, 1, "SETCAMERASMOOTHZOOMCONTROL", cmd_setcamerasmoothzoomcontrol, {-1}},
  {1, 1, "SETCLIPBOARDTEXT", cmd_setclipboardtext, {-1}},
  {1, 1, "SETCONFIGFLAGS", cmd_setconfigflags, {-1}},
  {1, 1, "SETEXITKEY", cmd_setexitkey, {-1}},
  //{1, 1, "SETGESTURESENABLED", cmd_setgesturesenabled, {-1}},
  {1, 1, "SETMASTERVOLUME", cmd_setmastervolume, {-1}},
  //{3, 3, "SETMATERIALTEXTURE", cmd_setmaterialtexture, {-1}},
  //{1, 1, "SETMATRIXMODELVIEW", cmd_setmatrixmodelview, {-1}},
  //{1, 1, "SETMATRIXPROJECTION", cmd_setmatrixprojection, {-1}},
  //{3, 3, "SETMODELMESHMATERIAL", cmd_setmodelmeshmaterial, {-1}},
  {1, 1, "SETMOUSECURSOR", cmd_setmousecursor, {-1}},
  {2, 2, "SETMOUSEOFFSET", cmd_setmouseoffset, {-1}},
  {2, 2, "SETMODELDIFFUSETEXTURE", cmd_setmodeldiffusetexture, {-1}},
  {2, 2, "SETMOUSEPOSITION", cmd_setmouseposition, {-1}},
  {2, 2, "SETMOUSESCALE", cmd_setmousescale, {-1}},
  {2, 2, "SETMUSICPITCH", cmd_setmusicpitch, {-1}},
  {2, 2, "SETMUSICVOLUME", cmd_setmusicvolume, {-1}},
  //{3, 3, "SETPIXELCOLOR", cmd_setpixelcolor, {-1}},
  //{4, 4, "SETSHADERVALUE", cmd_setshadervalue, {-1}},
  //{3, 3, "SETSHADERVALUEMATRIX", cmd_setshadervaluematrix, {-1}},
  //{3, 3, "SETSHADERVALUETEXTURE", cmd_setshadervaluetexture, {-1}},
  {4, 5, "SETSHADERVALUEV", cmd_setshadervaluev, {-1}},
  //{2, 2, "SETSHAPESTEXTURE", cmd_setshapestexture, {-1}},
  {2, 2, "SETSOUNDPITCH", cmd_setsoundpitch, {-1}},
  {2, 2, "SETSOUNDVOLUME", cmd_setsoundvolume, {-1}},
  {1, 1, "SETTARGETFPS", cmd_settargetfps, {-1}},
  //{2, 2, "SETTEXTUREFILTER", cmd_settexturefilter, {-1}},
  //{2, 2, "SETTEXTUREWRAP", cmd_settexturewrap, {-1}},
  //{1, 1, "SETTRACELOGCALLBACK", cmd_settracelogcallback, {-1}},
  {1, 1, "SETTRACELOGEXIT", cmd_settracelogexit, {-1}},
  {1, 1, "SETTRACELOGLEVEL", cmd_settraceloglevel, {-1}},
  //{2, 2, "SETVRCONFIGURATION", cmd_setvrconfiguration, {-1}},
  //{1, 1, "SETWINDOWICON", cmd_setwindowicon, {-1}},
  {2, 2, "SETWINDOWMINSIZE", cmd_setwindowminsize, {-1}},
  {1, 1, "SETWINDOWMONITOR", cmd_setwindowmonitor, {-1}},
  {2, 2, "SETWINDOWPOSITION", cmd_setwindowposition, {-1}},
  {2, 2, "SETWINDOWSIZE", cmd_setwindowsize, {-1}},
  {1, 1, "SETWINDOWTITLE", cmd_setwindowtitle, {-1}},
  {0, 0, "SHOWCURSOR", cmd_showcursor, {-1}},
  //{1, 1, "STOPAUDIOSTREAM", cmd_stopaudiostream, {-1}},
  {1, 1, "STOPMUSICSTREAM", cmd_stopmusicstream, {-1}},
  {1, 1, "STOPSOUND", cmd_stopsound, {-1}},
  {0, 0, "STOPSOUNDMULTI", cmd_stopsoundmulti, {-1}},
  {1, 1, "TAKESCREENSHOT", cmd_takescreenshot, {-1}},
  //{3, 3, "TEXTAPPEND", cmd_textappend, {-1}},
  {0, 0, "TOGGLEFULLSCREEN", cmd_togglefullscreen, {-1}},
  {0, 0, "TOGGLEVRMODE", cmd_togglevrmode, {-1}},
  ...
  //{1, 1, "UNLOADMODELANIMATION", cmd_unloadmodelanimation, {-1}},
  {1, 1, "UNLOADMUSICSTREAM", cmd_unloadmusicstream, {-1}},
  {1, 1, "UNLOADRENDERTEXTURE", cmd_unloadrendertexture, {-1}},
  {1, 1, "UNLOADSHADER", cmd_unloadshader, {-1}},
  {1, 1, "UNLOADSOUND", cmd_unloadsound, {-1}},
  {1, 1, "UNLOADTEXTURE", cmd_unloadtexture, {-1}},
  //{1, 1, "UNLOADWAVE", cmd_unloadwave, {-1}},
  //{3, 3, "UPDATEAUDIOSTREAM", cmd_updateaudiostream, {-1}},
  {1, 1, "UPDATECAMERA", cmd_updatecamera, {-1}},
  //{3, 3, "UPDATEMODELANIMATION", cmd_updatemodelanimation, {-1}},
  {1, 1, "UPDATEMUSICSTREAM", cmd_updatemusicstream, {-1}},
  //{3, 3, "UPDATESOUND", cmd_updatesound, {-1}},
  {2, 2, "UPDATETEXTURE", cmd_updatetexture, {-1}},
  //{3, 3, "UPDATETEXTUREREC", cmd_updatetexturerec, {-1}},
  //{1, 1, "UPDATEVRTRACKING", cmd_updatevrtracking, {-1}},
  //{3, 3, "WAVECROP", cmd_wavecrop, {-1}},
  //{4, 4, "WAVEFORMAT", cmd_waveformat, {-1}},
  {0, 0, "GUICLEARTOOLTIP", cmd_guicleartooltip, {-1}},
  {0, 0, "GUIDISABLE", cmd_guidisable, {-1}},
  {0, 0, "GUIDISABLETOOLTIP", cmd_guidisabletooltip, {-1}},
  {2, 2, "GUIDUMMYREC", cmd_guidummyrec, {-1}},
  {0, 0, "GUIENABLE", cmd_guienable, {-1}},
  {0, 0, "GUIENABLETOOLTIP", cmd_guienabletooltip, {-1}},
  {1, 1, "GUIFADE", cmd_guifade, {-1}},
  {2, 2, "GUIGROUPBOX", cmd_guigroupbox, {-1}},
  {2, 2, "GUILABEL", cmd_guilabel, {-1}},
  {2, 2, "GUILINE", cmd_guiline, {-1}},
  {1, 1, "GUILOADSTYLE", cmd_guiloadstyle, {-1}},
  ...
  {2, 2, "GUISTATUSBAR", cmd_guistatusbar, {-1}},
  {0, 0, "GUIUNLOCK", cmd_guiunlock, {-1}},
};
