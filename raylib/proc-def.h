  ...
  {4, 4, "DRAWSPLINEBASIS", cmd_drawsplinebasis},
  {4, 4, "DRAWSPLINEBEZIERCUBIC", cmd_drawsplinebeziercubic},
  {4, 4, "DRAWSPLINEBEZIERQUADRATIC", cmd_drawsplinebezierquadratic},
  {4, 4, "DRAWSPLINECATMULLROM", cmd_drawsplinecatmullrom},
  {4, 4, "DRAWSPLINELINEAR", cmd_drawsplinelinear},
  {6, 6, "DRAWSPLINESEGMENTBASIS", cmd_drawsplinesegmentbasis},
  {6, 6, "DRAWSPLINESEGMENTBEZIERCUBIC", cmd_drawsplinesegmentbeziercubic},
  {5, 5, "DRAWSPLINESEGMENTBEZIERQUADRATIC", cmd_drawsplinesegmentbezierquadratic},
  {6, 6, "DRAWSPLINESEGMENTCATMULLROM", cmd_drawsplinesegmentcatmullrom},
  {4, 4, "DRAWSPLINESEGMENTLINEAR", cmd_drawsplinesegmentlinear},
  ...
  {1, 1, "PLAYAUTOMATIONEVENT", cmd_playautomationevent},
  ...
  {1, 1, "SETAUTOMATIONEVENTBASEFRAME", cmd_setautomationeventbaseframe},
  {1, 1, "SETAUTOMATIONEVENTLIST", cmd_setautomationeventlist},
  {1, 1, "SETCLIPBOARDTEXT", cmd_setclipboardtext},
  {1, 1, "SETCONFIGFLAGS", cmd_setconfigflags},
  {1, 1, "SETEXITKEY", cmd_setexitkey},
  {4, 4, "SETGAMEPADVIBRATION", cmd_setgamepadvibration},
  ...
  {0, 0, "STARTAUTOMATIONEVENTRECORDING", cmd_startautomationeventrecording},
  {1, 1, "STOPAUDIOSTREAM", cmd_stopaudiostream},
  {0, 0, "STOPAUTOMATIONEVENTRECORDING", cmd_stopautomationeventrecording},
