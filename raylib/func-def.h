  ...
  {1, 1, "ISAUDIOSTREAMREADY", cmd_isaudiostreamready},
  ...
  {1, 1, "ISMODELREADY", cmd_ismodelready},
  ...
  {1, 1, "ISMUSICREADY", cmd_ismusicready},
  {1, 1, "ISMUSICSTREAMPLAYING", cmd_ismusicstreamplaying},
  {1, 1, "ISPATHFILE", cmd_ispathfile},
  {1, 1, "ISRENDERTEXTUREREADY", cmd_isrendertextureready},
  {1, 1, "ISSHADERREADY", cmd_isshaderready},
  {1, 1, "ISSOUNDPLAYING", cmd_issoundplaying},
  {1, 1, "ISSOUNDREADY", cmd_issoundready},
  {1, 1, "ISTEXTUREREADY", cmd_istextureready},
  {1, 1, "ISWAVEREADY", cmd_iswaveready},
