  ...
  {2, 2, "DECODEDATABASE64", cmd_decodedatabase64},
  {3, 3, "DECOMPRESSDATA", cmd_decompressdata},
  {1, 1, "DIRECTORYEXISTS", cmd_directoryexists},
  {3, 3, "ENCODEDATABASE64", cmd_encodedatabase64},
  ...
  {2, 2, "GETCODEPOINT", cmd_getcodepoint},
  ...
  {2, 2, "LOADCODEPOINTS", cmd_loadcodepoints},
  ...
  {3, 3, "LOADIMAGEPALETTE", cmd_loadimagepalette},
